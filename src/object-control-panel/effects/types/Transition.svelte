<script type="ts">
	...
	import { objectsSlice, ObjectTransitionEffect } from '@/store/object.store';
	export let effect: ObjectTransitionEffect;
...
<div class="property">
	...
	<div class="property-value">
		<QueInput type="number" value={effect.duration} on:change={(e) => onChange('duration', e)} />
	</div>
</div>
